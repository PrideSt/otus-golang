...
func TestParseString(t *testing.T) {
	for _, tt := range [...]struct{
		...
		},
		{
			name: `Simple char`,
			input: `a`,
			expected: GroupStorage{[]repeatGroup{repeatGroup{[]byte("a"), 1}}},
		},
		{
			name: `a2b3c0d-2`,
			input: `a2b3c0d-2`,
			expected: GroupStorage{[]repeatGroup{
				repeatGroup{[]byte("a"), 2},
				repeatGroup{[]byte("b"), 3},
				repeatGroup{[]byte("c"), 0},
				repeatGroup{[]byte("d"), 1},
				repeatGroup{[]byte("-"), 2},
			}},
		},
		// escape tests
		{
			...
			input: `q\4\5`,
			expected: GroupStorage{[]repeatGroup{
				repeatGroup{[]byte("q"), 1},
				repeatGroup{[]byte("4"), 1},
				repeatGroup{[]byte("5"), 1},
			}},
		},
		{
			name: `Escape repeat`,
		...
		},
		{
			...
			// expected aé́é́
			expected: GroupStorage{[]repeatGroup{
				repeatGroup{[]byte("a"), 1},
				repeatGroup{[]byte{0x65, 0xcc, 0x81, 0xcc, 0x81}, 2},
				//             e = 0x65
				//                   ' = 0xcc, 0x81
				//                  			 ' = 0xcc, 0x81
			}},
		...
		},
		{
			...
			expected: GroupStorage{[]repeatGroup{
				repeatGroup{[]byte("a"), 1},
				repeatGroup{[]byte{0xF0, 0x9D, 0x9F, 0xB9}, 1},
			}},
		},
		{
			...
			expected: GroupStorage{[]repeatGroup{
				repeatGroup{[]byte("a"), 1},
				repeatGroup{[]byte{0xF0, 0x9D, 0x9F, 0xB9}, 2},
			}},
		},
	} {
...
func TestUnpack(t *testing.T) {
	for _, tt := range [...]struct{
		...
		{
			name: `Simple char`,
			input: GroupStorage{[]repeatGroup{repeatGroup{[]byte("a"), 1}}},
			expected: `a`,
		},
		{
			name: `a2b3c0d-2`,
