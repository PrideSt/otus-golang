...
func benchTopNFromM(t *testing.B, resultCnt int, dictSz int) {
	...
	t.Run("measure Buffer", func(t *testing.B) {
		for i := 0; i < t.N; i++ {
			tb := NewBuffer(resultCnt, cmpGt)
...
// BenchmarkTop10Of100/measure_Buffer-8     	  236230	      5165 ns/op	     240 B/op	       1 allocs/op
...
// BenchmarkTop10Of1K/measure_Buffer-8      	   39016	     30559 ns/op	     240 B/op	       1 allocs/op
...
// BenchmarkTop10Of10K/measure_Buffer-8     	    4742	    251064 ns/op	     240 B/op	       1 allocs/op
...
// BenchmarkTop100Of10K/measure_Buffer-8    	    1930	    604759 ns/op	    2688 B/op	       1 allocs/op
